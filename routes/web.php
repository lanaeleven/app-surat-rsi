...
Route::get('/surat-masuk/{keterangan}', [SuratMasukController::class, 'create'])->middleware('admin');
Route::get('/surat-masuk/tambah', [SuratMasukController::class, 'tambah'])->middleware('admin');
