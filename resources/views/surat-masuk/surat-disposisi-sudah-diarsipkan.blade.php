...
<div class="div">
    ...
    <div class="d-flex justify-content-between align-itemsz-center my-2">
      ...
      <div>
        <h3 class="fw-bold fs-4 text-center">Surat Masuk yang Sudah Diarsipkan</h3>
      </div>
    ...
    @if ($suratMasuk->isEmpty())
        ...
        <p class="text-center fs-6 my-5">Anda Tidak Memiliki Surat Masuk yang Sudah Diarsipkan</p>
