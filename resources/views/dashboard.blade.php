                        ...
                        <div class="col-sm-4 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="/surat-masuk/ns/belum-diteruskan" class="btn btn-sm btn-primary">Lihat
                                        Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="/surat-masuk/ns/sudah-diteruskan" class="btn btn-sm btn-primary">Lihat
                                        Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="/surat-masuk/ns/sudah-diarsipkan" class="btn btn-sm btn-primary">Lihat
                                        Selengkapnya</a>
                                </div>
                            </div>
                        </div>
