...
@section('container')
    <div>
        <div class="d-flex justify-content-between align-items-center my-4">
            <div>
                <a href="/spo/index?tahun={{ config('app.tahun') }}" class="btn btn-warning btn-sm"><i
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input name="tanggalSurat" type="date" class="form-control" id="tanggalSurat"
                                value="{{ $spo->tanggalSurat }}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select name="direksi" class="form-select" id="direktorat" required>
                                ...
                                @foreach ($direksi as $d)
                                    <option value="{{ $d->id }}" @if ($spo->idDireksi == $d->id) selected @endif>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col">
                                    <a href="{{ asset('storage/' . $spo->filePath) }}" class="mt-1 btn btn-success btn-sm"
                                        target="_blank">view</a>
                                    <a href="{{ asset('storage/' . $spo->filePath) }}" class="mt-1 btn btn-primary btn-sm"
                                        download='{{ $spo->fileName }}'>download</a>
                                </div>
                            </div>
                        </div>
                    </div>
