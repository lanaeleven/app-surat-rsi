        ...
        <div>
            ...
            <div class="d-flex justify-content-between my-2">
                ...
                <div class="mb-2">
                    ...
                    <a href="/informasi/tambah" class="btn btn-primary btn-sm d-md-none d-lg-none d-xl-none d-xxl-none"><i
            ...
            <div>
                <form class="row g-3" action="">
                    <div class="row g-3">
                        <div class="col-auto">
                            <input name="tahun" type="number" class="form-control form-control-sm" placeholder="Tahun"
                                value="{{ request('tahun') }}">
                        </div>
                        <div class="col-auto">
