...
<div>
    ...
    <div class="d-flex justify-content-between align-items-center my-4">
      <div>
        <a href="/regulasi/index?tahun={{ config('app.tahun') }}" class="btn btn-warning btn-sm"><i class="fa-solid fa-arrow-left" style="color: #000;"></i></a>
      </div>
      <div>
            ...
            <form method="post" id="formEdit" action="/regulasi/save" enctype="multipart/form-data">
              ...
              <input type="hidden" name="tahun" value="{{ $regulasi->tahun }}">
                  ...
                  <div class="col-sm-9">
                    <select name="jenisRegulasi" class="form-select" id="jenisRegulasi" required>
                        ...
                        @foreach ($jenisRegulasi as $jr)
                          ...
                          <option value="{{ $jr->id }}" @if ($regulasi->idJenisRegulasi == $jr->id)
                              selected
                          @endif>{{ $jr->kodeJenisRegulasi.'-'.$jr->keterangan }}</option>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <input name="tanggalSurat" type="date" class="form-control" id="tanggalSurat" value="{{ $regulasi->tanggalSurat }}" required>
                  </div>
                </div>
                <div class="row mb-3">
                    <label for="tujuan" class="col-sm-3 col-form-label">Tujuan</label>
                    <div class="col-sm-9">
                      <input name="tujuan" type="text" class="form-control" id="tujuan" value="{{ $regulasi->tujuan }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <select name="direksi" class="form-select" id="direktorat" required>
                          ...
                          <option value="{{ $d->id }}" @if ($regulasi->idDireksi == $d->id)
                              selected
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="row justify-content-between align-items-center">
                          ...
                          <div class="col">
                            <a href="{{ asset('storage/' . $regulasi->filePath) }}" class="mt-1 btn btn-success btn-sm" target="_blank">view</a>
                            <a href="{{ asset('storage/' . $regulasi->filePath) }}" class="mt-1 btn btn-primary btn-sm" download='{{ $regulasi->fileName }}'>download</a>
                          </div>
                        </div>
                      </div>
                </div>
